...
# Config
COPY web-fordel/target/classes/*.xml /app/
COPY web-fordel/target/classes/jetty/jaspi-conf.xml /app/conf/

# Application Container (Jetty)
COPY web-fordel/target/app.jar /app/
COPY web-fordel/target/lib/*.jar /app/lib/
