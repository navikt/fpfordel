...
public class AppPdpRequestBuilderImplTest {
    ...
    public void skal_legge_aktør_id_og_ikke_fnr_på_request() throws Exception {
        ...
        assertThat(request.getAntall(CommonAttributter.RESOURCE_FELLES_PERSON_FNR)).isEqualTo(0);
    }
    ...
    public void skal_hente_to_aktør_id_gitt_forsendelse_id_som_input() {
        ...
        PdpRequest request = requestBuilder.lagPdpRequest(attributter);
        assertThat(request.getListOfString(CommonAttributter.RESOURCE_FELLES_PERSON_AKTOERID_RESOURCE)).contains(AKTØR);
        assertThat(request.getListOfString(CommonAttributter.RESOURCE_FELLES_PERSON_AKTOERID_RESOURCE)).hasSize(2);
    }
