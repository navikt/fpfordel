...
public enum VariantFormat implements Kodeverdi {
    ...
    public static final String KODEVERK = "VARIANT_FORMAT";
    ...
    public static VariantFormat fraKodeDefaultUdefinert(@JsonProperty("kode") String kode) {
        if (kode == null) {
            return UDEFINERT;
        }
