...
/**
 * Representerer et kodeverk brukt i applikasjonen. Hvert kodeverk har en eier
 * (default er 'VL' dvs. det er internt kodeverk)
 * <p>
 * Dersom noen av synk flaggene er satt skal dette kodeverket synkroniseres
 * automatisk med kodeverk eier (fungerer bare hvis eier støtter dette og vi har
 * implementert det).
 */
...
public class Kodeverk extends KodeverkTabell {
    ...
    /**
     * For å kunne skape instanser hvor man ikke leser opp fra databasen slik som
     * ved enhetstesting.
     */
