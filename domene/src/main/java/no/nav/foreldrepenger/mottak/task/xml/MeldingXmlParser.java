...
import static no.nav.vedtak.felles.integrasjon.felles.ws.JaxbHelper.unmarshalAndValidateXMLWithStAX;
import static no.nav.vedtak.felles.integrasjon.felles.ws.JaxbHelper.unmarshalXMLWithStAX;
