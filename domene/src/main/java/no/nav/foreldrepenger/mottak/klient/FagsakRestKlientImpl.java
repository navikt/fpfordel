...
public class FagsakRestKlientImpl implements FagsakRestKlient {
    ...
    public FagsakRestKlientImpl() { //NOSONAR: for cdi
    }
    ...
    public FagsakRestKlientImpl(OidcRestClient oidcRestClient, KodeverkRepository kodeverkRepository,
                                ...
                                @KonfigVerdi(ENDPOINT_KEY_OPPRETT_SAK) URI endpoint2, @KonfigVerdi(ENDPOINT_KEY_KNYTT_SAK_OG_JOURNALPOST) URI endpoint3,
    ...
    public VurderFagsystemResultat vurderFagsystem(MottakMeldingDataWrapper dataWrapper) {
        ...
        // VurderFagsystemDto burde hatt et felt for første uttaksdag for søknad. For å ikke kaste
        // mottatt søknad til manuell journalføring i fpsak, sender vi her første uttaksdag i et
